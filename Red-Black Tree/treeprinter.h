...
private:
    ...
    void compute_left_profile(AsciiNode *node, int x, int y)
    {
        ...
        compute_left_profile(node->left, x - node->edge_length - 1, y + node->edge_length + 1);
        compute_left_profile(node->right, x + node->edge_length + 1, y + node->edge_length + 1);
    }
    ...
    void compute_right_profile(AsciiNode *node, int x, int y)
    {
        ...
        compute_right_profile(node->left, x - node->edge_length - 1, y + node->edge_length + 1);
        compute_right_profile(node->right, x + node->edge_length + 1, y + node->edge_length + 1);
    }
